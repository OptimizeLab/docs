...
2） 下载打开页面之后根据自己的需求选择对应平台下载，本次安装选择的在linux平台安装arm这个版本。如下图所示：

![image](images/Install-version.png)
...
![image](images/Install-install.png)
...
![image](images/Install-gofile.png)
...
![image](images/Install-result.png)
